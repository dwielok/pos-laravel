...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Quick search/filter functionality (optional)
            const searchInput = document.createElement('input');
            searchInput.type = 'text';
            searchInput.placeholder = 'Search units...';
            searchInput.className =
                'w-full sm:w-48 rounded-xl border-theme px-4 py-2 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition';
            searchInput.id = 'unit-search';
            ...
            if (header) {
                ...
                <div class="relative">
                    ...
                    <input type="text" id="unit-search" placeholder="Search units..."
                        class="w-full sm:w-48 rounded-xl border-theme pl-9 pr-4 py-2 bg-primary-green-light/10 text-sm focus:ring-2 focus:ring-primary-green focus:border-transparent transition">
                </div>
            `;
